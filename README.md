...
## Demo WebSite
- **Demmo Web:**  [Link](http://140.113.164.91:8888)
...
> For CPU-only PaddlePaddle, use the appropriate command from [https://www.paddlepaddle.org.cn/install/quick](https://www.paddlepaddle.org.cn/install/quick).
...
> **Note:** The `MobileFaceSwap_224.pdparams` checkpoint (pretrained weights) must be downloaded manually from: [https://github.com/Seanseattle/MobileFaceSwap/blob/main/checkpoints/MobileFaceSwap\_224.pdparams?raw=true](https://github.com/Seanseattle/MobileFaceSwap/blob/main/checkpoints)

### defect\_detector\_hf.py
...
- **MobileFaceSwap GitHub Repository:** [https://github.com/Seanseattle/MobileFaceSwap](https://github.com/Seanseattle/MobileFaceSwap)
- **HuggingFace Deepfake Models:** [https://huggingface.co/models?sort=downloads&search=deepfake](https://huggingface.co/models?sort=downloads\&search=deepfake)
